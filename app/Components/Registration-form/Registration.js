...
const Registration = () => {
    return (
        <div className='flex  items-center justify-center bg-transparent'>
            <form className=' form-box shadow-zinc-50 shadow-2xl background-image mt-14 box-border h-full w-6/12 p-4 border-4 form-round flex content-center flex-col bg-gray-700 md:box-content'  >
